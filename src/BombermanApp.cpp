...
namespace BombermanGraphics
{
  ...
  std::initializer_list<
     ...
     //   |____|                 |    |    |   |
          ...
          {EXP_DOWN_1,          {80 , 352, 12, 12}},
          {EXP_DOWN_2,          {56 , 352, 12, 12}},
          {EXP_DOWN_3,          {32 , 352, 12, 12}},
          {EXP_DOWN_4,          {8  , 352, 12, 12}},
          //FIXME Set the true coordinates
          {EXP_UP_1,            {296, 352, 12, 12}},
          {EXP_UP_2,            {272, 352, 12, 12}},
          {EXP_UP_3,            {248, 352, 12, 12}},
          {EXP_UP_4,            {224, 352, 12, 12}},
          {EXP_RIGHT_1,         {200, 352, 12, 12}},
          {EXP_RIGHT_2,         {176, 352, 12, 12}},
          {EXP_RIGHT_3,         {152, 352, 12, 12}},
          {EXP_RIGHT_4,         {128, 352, 12, 12}}
      };
}
...
void BombermanApp::loadTilemap()
{
  ...
  m_texture_map.insert(BombermanGraphics::TEXTURE_ASSOCIATIONS);
}
...
void BombermanApp::propagateExplosion(int x, int y, Direction dir, int power) {
  ...
  while(keep_going) {
    ...
    // Si la case n'est pas vide:
        ...
        //TODO Lancer la destruction du bloc
...
SDL_Rect BombermanApp::getCurrentTexture(int x, int y)
{
  ...
  if (tile->getMask() & TileContent::BOMB)
  {
    switch ((4 * getFramecount() / getFramerate()) % 4)
    {
    case 0:
      return m_texture_map[BombermanGraphics::BOMB_1];
    case 1:
      return m_texture_map[BombermanGraphics::BOMB_2];
    case 2:
      return m_texture_map[BombermanGraphics::BOMB_3];
    case 3:
      return m_texture_map[BombermanGraphics::BOMB_2];
    default:
  ...
  if (tile->getMask() & TileContent::EXPLOSION)
  {
    ...
    case 0:
      ...
      {
      case NONE:
        return m_texture_map[BombermanGraphics::EXP_CENTER_4];
      case HORIZONTAL:
        return m_texture_map[BombermanGraphics::EXP_HORIZONTAL_4];
      case VERTICAL:
        return m_texture_map[BombermanGraphics::EXP_VERTICAL_4];
      case SOUTH:
        return m_texture_map[BombermanGraphics::EXP_DOWN_4];
      case NORTH:
        return m_texture_map[BombermanGraphics::EXP_UP_4];
      case EAST:
        return m_texture_map[BombermanGraphics::EXP_RIGHT_4];
      case WEST:
        return m_texture_map[BombermanGraphics::EXP_LEFT_4];
      }
    case 1:
      switch (tile->getExplosion()->dir)
      {
      case NONE:
        return m_texture_map[BombermanGraphics::EXP_CENTER_3];
      case HORIZONTAL:
        return m_texture_map[BombermanGraphics::EXP_HORIZONTAL_3];
      case VERTICAL:
        return m_texture_map[BombermanGraphics::EXP_VERTICAL_3];
      case SOUTH:
        return m_texture_map[BombermanGraphics::EXP_DOWN_3];
      case NORTH:
        return m_texture_map[BombermanGraphics::EXP_UP_3];
      case EAST:
        return m_texture_map[BombermanGraphics::EXP_RIGHT_3];
      case WEST:
        return m_texture_map[BombermanGraphics::EXP_LEFT_3];
      }
    case 2:
      switch (tile->getExplosion()->dir)
      {
      case NONE:
        return m_texture_map[BombermanGraphics::EXP_CENTER_2];
      case HORIZONTAL:
        return m_texture_map[BombermanGraphics::EXP_HORIZONTAL_2];
      case VERTICAL:
        return m_texture_map[BombermanGraphics::EXP_VERTICAL_2];
      case SOUTH:
        return m_texture_map[BombermanGraphics::EXP_DOWN_2];
      case NORTH:
        return m_texture_map[BombermanGraphics::EXP_UP_2];
      case EAST:
        return m_texture_map[BombermanGraphics::EXP_RIGHT_2];
      case WEST:
        return m_texture_map[BombermanGraphics::EXP_LEFT_2];
      }
    case 3:
      switch (tile->getExplosion()->dir)
      {
      case NONE:
        return m_texture_map[BombermanGraphics::EXP_CENTER_1];
      case HORIZONTAL:
        return m_texture_map[BombermanGraphics::EXP_HORIZONTAL_1];
      case VERTICAL:
        return m_texture_map[BombermanGraphics::EXP_VERTICAL_1];
      case SOUTH:
        return m_texture_map[BombermanGraphics::EXP_DOWN_1];
      case NORTH:
        return m_texture_map[BombermanGraphics::EXP_UP_1];
      case EAST:
        return m_texture_map[BombermanGraphics::EXP_RIGHT_1];
      case WEST:
        return m_texture_map[BombermanGraphics::EXP_LEFT_1];
      }
    default:
